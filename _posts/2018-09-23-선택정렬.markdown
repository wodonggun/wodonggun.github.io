...
> <a> 8 5 2 6 9 3 1 4 0 7 </a> <br>간단하게 8번이 있는 `첫번째 자리`를 선택하고 -> 1~10번째까지 가장 작은 수 전체 탐색 <br>
...
2번이 있는 세번째 자리가 가장 작으므로 그냥 그대로 유지 (3 싸이클)<br><br><center>.</center><center>.</center><center>.</center><br><center>`N번째 싸이클까지 반복.....`</center>
